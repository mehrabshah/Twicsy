  ...
  return (
    ...
    <div className="shell">
        ...
        <div className="footer__cols">
          ...
          <div className="footer__col footer__col-2">
            <nav className="footer__nav ">
              <ul style={{color: "#101820FF"}} >
                <li>
                  <a className="animated-link is-active  " href="/"
                ...
                <li>
                  <a className="animated-link" href="/contact"
                    ...
                    ><span className="nav__char ad5"
                      >t</span
                    ><span  className="nav__char ad6"
                      >a</span
                    ><span className="nav__char ad7"
                      >c</span
                    ><span className="nav__char ad8"
                      >t</span
                    ></a
                  >
                </li>
                <li>
                  <a className="animated-link" href="/blog"
                    ><span className="nav__char ad2"
                      >B</span
                    ><span className="nav__char ad3"
                      >l</span
          ...
          <div className="footer__col footer__col-3">
            <div className="list-offers text-center text-xsm">
              <ul>
                <li>
                  <div className="offer">
                ...
                <li>
                  <div className="offer">
                    <a className="btn" href="/buy-instagram-likes"
                      ><span></span><span></span><span></span
                      ><strong>Buy Instagram Likes</strong></a
                    >
                    <div className="offer__inner">
                      <p>
                ...
                <li>
                  <div className="offer">
                    <a className="btn" href="/buy-instagram-views"
                      ><span></span><span></span><span></span
                      ><strong>Buy Instagram Views</strong></a
                    >
                    <div className="offer__inner">
                      <p>
          ...
          <div className="footer__col footer__col-4">
            <div className="footer__copyright">
              2022 Vip Followers — All Rights Reserved
            </div>
          </div>
        </div>
      ...
      <div className="footer__bar">
        <ul>
          <li>
            <a className="animated-link" href="/terms"
              ><span  className="nav__char ad2">T</span
              ><span  className="nav__char ad3">e</span
              ><span  className="nav__char ad4">r</span
              ><span  className="nav__char ad5"
                >m</span
              ><span className="nav__char ad6"
                >s</span
              ><span
                ...
                className="nav__char is-empty ad7"
              >
              </span
              ><span  className="nav__char ad8"
                >o</span
              ><span  className="nav__char ad9"
                >f</span
              ><span
                
                className="nav__char is-empty ad10"
              >
              </span
              ><span  className="nav__char ad11"
                >S</span
              ><span  className="nav__char ad12"
                >e</span
              ><span  className="nav__char ad13"
                >r</span
              ><span  className="nav__char ad14"
                >v</span
              ><span  className="nav__char ad15"
                >i</span
              ><span  className="nav__char ad16"
                >c</span
              ><span  className="nav__char ad17"
                >e</span
              ></a
            >
          </li>
          <li>
            <a className="animated-link" href="/contact"
              ><span className="nav__char ad2">C</span
              ><span className="nav__char ad3">o</span
              ><span className="nav__char ad4">n</span
              ><span  className="nav__char ad5"
                >t</span
              ><span  className="nav__char ad6"
                >a</span
              ...
              ><span  className="nav__char ad8"
                >t</span
              ><span
                className="nav__char is-empty ad9"
              >
              </span
              ><span  className="nav__char ad10"
                >U</span
              ><span  className="nav__char ad11"
                >s</span
              ></a
        ...
        <div className="payments">
          <ul>
            <li className="is-white">
              <svg
                className="svg-icon svg-icon--symantec"
                width="72"
                height="19"
                viewBox="0 0 77 22"
                fill="#fff"
            ...
            <li className="is-black">
              <svg
                className="svg-icon svg-icon--applePay"
                width="29"
                height="13"
                viewBox="0 0 29 13"
                fill="none"
            ...
            <li className="is-white">
              <svg
                className="svg-icon svg-icon--visa"
                width="28"
                height="10"
                viewBox="0 0 28 10"
                fill="none"
            ...
            <li className="is-white">
              <svg
                className="svg-icon svg-icon--mastercard"
                width="27"
                height="17"
                viewBox="0 0 27 17"
                fill="none"
            ...
            <li className="is-amex">
              <svg
                className="svg-icon svg-icon--americanExpress"
                width="33"
                height="9"
                viewBox="0 0 22 6"
                fill="none"
            ...
            <li className="is-white">
              <svg
                className="svg-icon svg-icon--dc"
                width="18"
                height="17"
                viewBox="0 0 20 17"
                fill="none"
