            ...
            <div className="hero__inner">
                    ...
                    <div className="phone">
                        <div className="phone__inner">
                            <div className="phone__display">
                                <div className="phone__battery"><img className="phone__confetti-1"
                                        src="./images/phone-battery.png"/></div>
                                <div className="phone__avatar">
                                    <div className="phone__confetti"><img className="phone__confetti-1"
                                            src="./images/confetti-img-1.svg"/><img className="phone__confetti-2"
                                            src="./images/confetti-img-2.svg"/><img className="phone__confetti-3"
                                            src="./images/confetti-img-3.svg"/><img className="phone__confetti-4"
                                            src="./images/confetti-img-4.svg"/><img className="phone__confetti-5"
                                            src="./images/confetti-img-5.svg"/><img className="phone__confetti-6"
                                            src="./images/confetti-img-6.svg"/><img className="phone__confetti-7"
                                            src="./images/confetti-img-7.svg"/></div>
                                    <div className="phone__avatar-image">
                                        <figure><span
                                                className="s1"><img
                                                    ...
                                                    className="s2"
                                                    sizes="100vw"
                                                    srcset="./images/women.png"/><noscript><img
                                                        sizes="100vw"
                                                        srcSet="./images/women.png"
                                                        src="./images/women.png"
                                                        decoding="async" data-nimg="fill"
                                                        className='s2'
                                                        loading="lazy" /></noscript></span></figure>
                                    </div>
                                        ...
                                        <div className="phone__message">
                                            <figure><span
                                                    className='s3'><span
                                                        ...
                                                        className="s6"
                                                        srcset="./images/100-emoji.png"/><noscript><img
                                    ...
                                    <li className="s7">
                                        <div className="phone__message">
                                            <figure><span
                                                    ...
                                                    className="s5"
                                                            alt="" aria-hidden="true"
                                                            src="data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMjQiIGhlaWdodD0iMjQiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyIgdmVyc2lvbj0iMS4xIi8+"/></span><img
                                                        src="./images/cowboy-emoji.png"
                                                        decoding="async" data-nimg="intrinsic"
                                                        className="s6"
                                                        srcset="./images/cowboy-emoji.png"/><noscript><img
                                ...
                                <div className="phone__heart phone__heart--left"><svg className="svg-icon svg-icon--heart"
                                ...
                                <div className="phone__heart phone__heart--right"><svg className="svg-icon svg-icon--heart"
                                        width="18" height="17" viewBox="0 0 18 17" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M9.07974 16.7646L7.83097 15.5086C3.19714 11.3708 0.168091 8.58102 0.168091 5.15948C0.168091 2.37529 2.30925 0.214355 5.06715 0.214355C6.58671 0.214355 8.10062 0.934894 9.07974 2.10338C10.0588 0.934876 11.5728 0.214355 13.0923 0.214355C15.8502 0.214355 17.9914 2.37529 17.9914 5.15948C17.9914 8.58093 14.9623 11.3707 10.3285 15.5086L9.07974 16.7646Z"
                            ...
                            <div className="blobs blobs--red">
                                <div className="blobs__holder">
                                    <div className="blob blob--left"><svg width="274" height="238" viewBox="0 0 274 238"
                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path className="blob__body"
                                            ...
                                            <path className="blob__face"
                                                ...
                                                stroke="#FF553C" stroke-width="4.92264" stroke-linecap="round"
                                                stroke-linejoin="round"></path>
                                        </svg></div>
                                    <div className="blob blob--middle"><svg width="349" height="340"
                                            viewBox="0 0 349 340" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path className="blob__body"
                                            ...
                                            <path className="blob__face"
                                                ...
                                                stroke="#FF553C" stroke-width="3.91287" stroke-linecap="round"
                                                stroke-linejoin="round"></path>
                                        </svg></div>
                                    <div className="blob blob--right"><svg width="267" height="234"
                                            viewBox="0 0 267 234" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path className="blob__body"
                                    ...
                                    <div className="blobs__arrow"><svg width="201" height="223" viewBox="0 0 201 223"
                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                ...
                                                fill="url(#paint0_linear_36_932)"></path>
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                d="M115.745 4.20756C107.382 -0.390078 97.2256 -0.284367 88.9609 4.48632L13.6544 47.9557C0.604693 55.4885 -3.86772 72.1739 3.66503 85.2236C11.1978 98.2734 27.8832 102.746 40.9329 95.213L76.8 74.5093L76.8 206.435C76.8 215.197 88.2784 222.3 102.438 222.3C116.597 222.3 128.075 215.197 128.075 206.435L128.075 73.2558L160.413 91.0352C173.617 98.2947 190.205 93.476 197.465 80.2723C204.724 67.0686 199.906 50.4799 186.702 43.2204L115.745 4.20756Z"
                                                fill="white"></path>
                                            <defs>
                                                <linearGradient id="paint0_linear_36_932" x1="188.471" y1="270.615"
                                                    x2="-2.11774" y2="132.631" gradientUnits="userSpaceOnUse">
                ...
                <div className="hero__content">
                    <div className="hero__text">
                        ...
                        <p>Hundreds of Instagram <span className="text-orange">Followers</span>, <span
                                className="text-orange">Likes</span>, and <span className="text-orange">Views</span><br
                                className="hidden-xs"/>– Real Users, Real Accounts, and Quick Delivery!</p>
                    </div>
                            ...
                            <div className="flex-col">
                                <div className="reviews-trustpilot">
                                    <div className="reviews__logo">
                                        <div className="svg-image svg-image--trustpilot"><svg
                                                xmlns="http://www.w3.org/2000/svg" width="108" height="26.514"
                                    ...
                                    <ul className="reviews__stars">
                                        <li className="is-active"><svg className="svg-icon svg-icon--TrustpilotStar"
                                                width="20" height="19" xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 25.866 24.588">
                                                <path
                                                    d="M13.032,2.09l3.042,9.4h9.882l-7.992,5.8,3.042,9.4-7.992-5.814L5.022,26.678l3.06-9.4L.09,11.468l9.882.018,3.06-9.4Zm4.932,15.192-4.932,3.582,5.616-1.458Z"
                                                    transform="translate(-0.09 -2.09)" fill="currentColor"></path>
                                            </svg></li>
                                        <li className="is-active"><svg className="svg-icon svg-icon--TrustpilotStar"
                                                width="20" height="19" xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 25.866 24.588">
                    ...
                    <div className="list-logos xs-justify-center">
                        <ul>
                            <li>
                                <div className="list__image"><span
                                        className='s3'><span
                                            className='s4'><img
                                            className='s5'
                                                alt="" aria-hidden="true"
                                                src="data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMTEwIiBoZWlnaHQ9IjQwIiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZlcnNpb249IjEuMSIvPg=="/></span><img
                                            alt="Logo"
                                            src="./images/logo-img-3.svg"
                                            decoding="async" data-nimg="intrinsic"
                                            className='s6'
                                            srcset="./images/logo-img-3.svg"/><noscript><img
                                                alt="Logo"
                            ...
                            <li>
                                <div className="list__image"><span
                                         ...
                                         className='s5'
                                                alt="" aria-hidden="true"
                                                src="data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMTAwIiBoZWlnaHQ9IjUwIiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZlcnNpb249IjEuMSIvPg=="/></span><img
                                            alt="Logo"
                                            src="./images/logo-img-2.svg"
                                            decoding="async" data-nimg="intrinsic"
                                            className='s6'
                                            srcset="./images/logo-img-2.svg"/><noscript><img
                                                alt="Logo"
                                                srcSet="/_next/image?url=%2Fimages%2Flogo-img-2.svg&amp;w=128&amp;q=75 1x, /_next/image?url=%2Fimages%2Flogo-img-2.svg&amp;w=256&amp;q=75 2x"
                                                src="./images/logo-img-2.svg"
                                                decoding="async" data-nimg="intrinsic"
                                                className='s6'
                                                loading="lazy" /></noscript></span></div>
                            ...
                            <li>
                                <div className="list__image"><span
                                          ...
                                          className='s5'
                                            ...
                                            decoding="async" data-nimg="intrinsic"
                                            className='s6'
                                            srcset="./images/logo-img-1.svg"/><noscript><img
                                                alt="Logo"
                                                srcSet="./images/logo-img-1.svg&amp;w=128&amp;q=75 1x, ./images/logo-img-1.svg&amp;w=256&amp;q=75 2x"
                                                src="./images/logo-img-1.svg&amp;w=256&amp;q=75"
                                                decoding="async" data-nimg="intrinsic"
                                                className='s6'
                                                loading="lazy" /></noscript></span></div>
                            </li>
                            <li>
                                <div className="list__image"><span
                                         ...
                                         className='s5'
                                                alt="" aria-hidden="true"
                                                src="data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMTIwIiBoZWlnaHQ9IjYwIiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZlcnNpb249IjEuMSIvPg=="/></span><img
                                            alt="Logo"
                                            src="./images/logo-img-4.svg"
                                            decoding="async" data-nimg="intrinsic"
                                            className='s6'
                                            srcset="./images/logo-img-4.svg"/><noscript><img
                                                alt="Logo"
                                                srcSet="/_next/image?url=%2Fimages%2Flogo-img-4.svg&amp;w=128&amp;q=75 1x, /_next/image?url=%2Fimages%2Flogo-img-4.svg&amp;w=256&amp;q=75 2x"
                                                src="./images/logo-img-4.svg"
                                                decoding="async" data-nimg="intrinsic"
                                                className='s6'
                                                loading="lazy" /></noscript></span></div>
